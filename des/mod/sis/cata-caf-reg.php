...
$select = "SELECT bp.* FROM CatContratoAfiliacion bp WHERE bp.eCodContrato = 1";
...
<div class="card proj-progress-card">
    <div class="card-block">
        ...
        <input type="hidden" name="eCodContrato" id="eCodContrato" value="1">
        ...
        <input type="hidden" name="eAccion" id="eAccion">
           ...
           <div class="form-group row">    
              <label class="col-sm-2 col-form-label">Contrato de Afiliaci&oacute;n</label>
               <div class="col-sm-10">
