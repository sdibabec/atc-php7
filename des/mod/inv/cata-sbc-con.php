...
if($_GET['eCodSubclasificacion'])
{
    mysqli_query($conexion,"DELETE FROM CatInventario WHERE eCodSubclasificacion =".$_GET['eCodSubclasificacion']);
...
function detalles(eCodCliente)
    {
        window.location="?tCodSeccion=cata-inv-det&eCodSubclasificacion="+eCodCliente;
    }
function eliminar(eCodSubclasificacion)
    {
        window.location="?tCodSeccion=cata-inv-con&eCodSubclasificacion="+eCodSubclasificacion;
    }
...
<div class="form-row">
    <div class="form-group col-md-3"><label><input type="radio" name="rdOrden" value="eCodSubclasificacion" checked="checked"> C&oacute;digo</label></div>
    <div class="form-group col-md-3">
        <input type="text" class="form-control" name="eCodSubclasificacion" id="eCodSubclasificacion">
    </div>
